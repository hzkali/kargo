...
Please install and activate it before starting to use the theme Kargo.

Also the theme supports many popular plugins such as 'Elementor', 'Revolution Slider', 'WPBakery Builder'
and many more. They can be installed after theme activation from the menu 'Theme Panel->Theme Dashboard->Plugins'.


III. Documentation

Theme documentation is available on http://kargo.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Kargo is Fontello.
