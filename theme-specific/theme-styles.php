...
if ( ! function_exists( 'kargo_customizer_get_css' ) ) {

	function kargo_customizer_get_css( $args = array() ) {
		...
		if ( $fonts ) {
			...
			$fonts = kargo_customizer_add_theme_fonts( $fonts );
...
CSS;
			$rez          = apply_filters( 'kargo_filter_get_css', $rez, array( 'fonts' => $fonts ) );
			$css['fonts'] = $rez['fonts'];
		}
		...
		//---------------------------------------------
		if ( null === $vars ) {
			$vars = kargo_get_theme_vars();
		}

		if ( $vars ) {

			// Make theme-specific fonts rules
			$vars = kargo_customizer_add_theme_vars( $vars );
			extract( $vars );
...
CSS;
			$rez          = apply_filters( 'kargo_filter_get_css', $rez, array( 'vars' => $vars ) );
			$css['vars']  = $rez['vars'];
		}
		...
		//--------------------------------------
		if ( false !== $colors ) {
			$schemes = empty( $scheme ) ? array_keys( kargo_get_sorted_schemes() ) : array( $scheme );
			...
			if ( count( $schemes ) > 0 ) {
				...
				foreach ( $schemes as $s ) {
					// Prepare colors
					if ( empty( $scheme ) ) {
						$colors = kargo_get_scheme_colors( $s );
					}

					// Make theme-specific colors and tints
					$colors = kargo_customizer_add_theme_colors( $colors );
...
.wp-caption-overlay .wp-caption .wp-caption-dd:after {
	background: linear-gradient(to right,	{$colors['extra_hover2']} 0%, {$colors['extra_link3']} 100%);
}
ul > li:before {
	color: {$colors['text_link']};
}
...
.post_featured.hover_dots .icons:hover:after {
	color: {$colors['inverse_text']};
	background-color: {$colors['text_link2']};
}
...
.widget .wp-block-search:not(.wp-block-search__no-button) .wp-block-search__inside-wrapper:after,
.widget_display_search form:after,
#bbpress-forums #bbp-search-form:after,
span.fake_button:after,
.wp-widget-search form:before,
.widget_search form:before,
.widget .wp-block-search:not(.wp-block-search__no-button) .wp-block-search__inside-wrapper:before,
.widget_display_search form:before,
#bbpress-forums #bbp-search-form:before {
	color: {$colors['text_link2']};
}
input[type="submit"][disabled] + span.fake_button:after,
input[type="submit"][disabled]:hover + span.fake_button:after,
input[type="submit"][disabled] + span.fake_button:before,
input[type="submit"][disabled]:hover + span.fake_button:before {
	color: {$colors['text_light']};
}
input[type="submit"]:hover + span.fake_button:after,
input[type="submit"]:hover + span.fake_button:before {
	color: {$colors['text_hover2']};
}
.widget_search form:hover:after,
.widget .wp-block-search:not(.wp-block-search__no-button) .wp-block-search__inside-wrapper:hover:after,
.widget_display_search form:hover:after,
#bbpress-forums #bbp-search-form:hover:after,
.widget_search form:hover:before,
.widget .wp-block-search:not(.wp-block-search__no-button) .wp-block-search__inside-wrapper:hover:before,
.widget_display_search form:hover:before,
#bbpress-forums #bbp-search-form:hover:before {
	color: {$colors['input_dark']};
}
.scheme_dark .wp-widget-search form:hover:after {
	color: {$colors['input_dark']};
}
...
.scheme_dark #fbuilder select {
	color: {$colors['text_light']};
	border-color: {$colors['inverse_link']};
	background-color: {$colors['inverse_link']};
}
.scheme_dark #fbuilder input {
	color: {$colors['text_light']};
	border-color: {$colors['inverse_link']};
	background-color: {$colors['inverse_link']};
}
.scheme_dark #fbuilder input[type="button"] {
	color: {$colors['inverse_link']};
	background-color: {$colors['extra_hover2']};
}
.scheme_dark #fbuilder input[type="button"]:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['alter_bg_color']};
}
...
.scheme_dark form.mc4wp-form input[placeholder]::-webkit-input-placeholder { color: {$colors['text_dark']}; }
.scheme_dark form.mc4wp-form input[placeholder]::-moz-placeholder { color: {$colors['text_dark']}; }
.scheme_dark form.mc4wp-form input[placeholder]:-ms-input-placeholder { color: {$colors['text_dark']}; }
.scheme_dark form.mc4wp-form input[placeholder]::placeholder { color: {$colors['text_dark']}; }

.scheme_dark #fbuilder .fields.cff-date-field input::-webkit-input-placeholder,
.scheme_dark #fbuilder .fields.cff-number-field input::-webkit-input-placeholder,
.scheme_dark #fbuilder .fields.cff-text-field input::-webkit-input-placeholder {
	color: {$colors['text_light']};
	opacity: 1;
}
.scheme_dark #fbuilder .fields.cff-date-field input::-moz-placeholder,
.scheme_dark #fbuilder .fields.cff-number-field input::-moz-placeholder,
.scheme_dark #fbuilder .fields.cff-text-field input::-moz-placeholder {
	color: {$colors['text_light']};
	opacity: 1;
}
.scheme_dark #fbuilder .fields.cff-date-field input:-ms-input-placeholder,
.scheme_dark #fbuilder .fields.cff-number-field input:-ms-input-placeholder,
.scheme_dark #fbuilder .fields.cff-text-field input:-ms-input-placeholder {
	color: {$colors['text_light']};
	opacity: 1;
}
.scheme_dark #fbuilder .fields.cff-date-field input::placeholder,
.scheme_dark #fbuilder .fields.cff-number-field input::placeholder,
.scheme_dark #fbuilder .fields.cff-text-field input::placeholder {
	color: {$colors['text_light']};
	opacity: 1;
}
.scheme_dark #fbuilder .fields.cff-calculated-field input::-webkit-input-placeholder {
	color: {$colors['inverse_link']};
	opacity: 1;
}
.scheme_dark #fbuilder .fields.cff-calculated-field input::-moz-placeholder {
	color: {$colors['inverse_link']};
	opacity: 1;
}
.scheme_dark #fbuilder .fields.cff-calculated-field input:-ms-input-placeholder {
	color: {$colors['inverse_link']};
	opacity: 1;
}
.scheme_dark #fbuilder .fields.cff-calculated-field input::placeholder {
	color: {$colors['inverse_link']};
	opacity: 1;
}
...
.sc_button_bordered:not(.sc_button_bg_image):after,
.sc_button_bordered:not(.sc_button_bg_image):before {
	background: {$colors['extra_hover2']};
}
...
.sc_button_bordered.color_style_link2:not(.sc_button_bg_image):after,
.sc_button_bordered.color_style_link2:not(.sc_button_bg_image):before {
...
.sc_button_bordered.color_style_link3:not(.sc_button_bg_image):after,
.sc_button_bordered.color_style_link3:not(.sc_button_bg_image):before {
	background: {$colors['extra_link3']};
}
...
.elementor-element.elementor-button-info .elementor-button:hover .fa-plus:before {
	color:{$colors['inverse_text']};
}
.elementor-button .fa-plus:before {
	color:{$colors['text_light']};
}
/* Bordered Greyscale */
.sc_button_greyscale:not(.sc_button_bg_image) {
	color:{$colors['text_dark']};
	border-color:{$colors['alter_bg_hover']} !important;
	background: none!important;
}
.sc_button_greyscale:not(.sc_button_bg_image):after,
.sc_button_greyscale:not(.sc_button_bg_image):before {
	background: {$colors['alter_bg_hover']};
}
.sc_button_greyscale:not(.sc_button_bg_image):hover {
	color:{$colors['text_dark']} !important;
	background: none!important;
}
.sc_button_greyscale:not(.sc_button_bg_image):hover:after,
.sc_button_greyscale:not(.sc_button_bg_image):hover:before {
...
/* ThemeREX Addons */
.sc_button_default,
.sc_button:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image):not(.sc_button_greyscale),
...
.wp-block-search .wp-block-search__inside-wrapper .sc_button_hover_slide_left:hover {
	background: {$colors['text_link']}!important;
}
.wp-block-search.wp-block-search__button-inside .wp-block-search__inside-wrapper {
	border-color:{$colors['input_bd_hover']};
}
.sidebar .wp-block-group .wp-block-search.wp-block-search__button-inside .wp-block-search__inside-wrapper {
...
.post_item.sticky .post_title a {
	color: {$colors['inverse_text']};
}
.post_item.sticky .post_title a:hover {
	color: {$colors['text_link2']};
}
.post_item.sticky .post_meta,
.post_item.sticky .post_meta a {
	color: {$colors['inverse_text']};
}
.post_item.sticky .post_meta a:hover {
	color: {$colors['text_link2']};
}
.post_item.sticky .post_meta .post_categories,
.post_item.sticky .post_meta .post_categories a {
	color: {$colors['text_link2']};
}
.post_item.sticky .post_meta .post_categories a:hover {
	color: {$colors['inverse_text']};
}
.post_item.sticky .post_meta .post_meta_item:after {
	color: {$colors['inverse_text']};
}
...
.sc_layouts_iconed_text_type_bold .sc_layouts_item_icon {
	color: {$colors['text_dark']};
}
...
.sc_layouts_item_link:hover .sc_layouts_item_details_line1,
.sc_layouts_item_link:hover .sc_layouts_item_details_line2 {
	color: {$colors['text_link2']};
}
.sc_layouts_iconed_text_type_reverse .sc_layouts_item_link:hover .sc_layouts_item_details_line1,
.sc_layouts_iconed_text_type_reverse .sc_layouts_item_link:hover .sc_layouts_item_details_line2 {
	color: {$colors['text_dark']};
}
...
.sc_layouts_iconed_text_type_reverse .sc_layouts_item_link:hover .sc_layouts_item_icon {
	background-color: {$colors['text_link2']};
	color: {$colors['inverse_text']};
}
...
.trx_addons_popup_link:hover .sc_layouts_item_details span {
	color: {$colors['text_link']};
}
.trx_addons_login_link:hover .sc_layouts_item_details_line1,
.trx_addons_login_link:hover .sc_layouts_item_details_line2 {
	color: {$colors['text_link']};
}
...
.footer_wrap .sc_layouts_row_type_narrow .sc_layouts_item a:not(.sc_button):not(.button),
.scheme_self.footer_wrap .sc_layouts_row_type_narrow .sc_layouts_item a:not(.sc_button):not(.button) {
	color: {$colors['alter_text']};
}
...
.sc_layouts_row_type_narrow .search_wrap .search_submit:hover .search_submit_custom,
.scheme_self.sc_layouts_row_type_narrow .search_wrap .search_submit:hover .search_submit_custom {
	color: {$colors['text_dark']};
}
...
.footer_wrap .scheme_dark.sc_layouts_row_type_compact .sc_layouts_item {
	color: {$colors['text']};
}
.footer_wrap .sc_layouts_row_type_compact .sc_layouts_item a:not(.sc_button):not(.button),
.footer_wrap .scheme_dark.sc_layouts_row_type_compact .sc_layouts_item a:not(.sc_button):not(.button) {
	color: {$colors['text']};
}
...
.sc_layouts_row_type_compact .search_wrap .search_submit_inner:hover,
...
.sc_layouts_row_type_compact .search_form_wrap_inner,
.sc_layouts_row_type_normal .search_form_wrap_inner,
.sc_layouts_row_type_narrow .search_form_wrap_inner,
.scheme_self.sc_layouts_row_type_compact .search_form_wrap_inner,
.scheme_self.sc_layouts_row_type_normal .search_form_wrap_inner,
.scheme_self.sc_layouts_row_type_narrow .search_form_wrap_inner {
	background-color: {$colors['extra_bg_color']};
}
...
.sc_layouts_row_type_compact .search_form_wrap_inner .search_submit_inner,
.sc_layouts_row_type_normal .search_wrap .search_submit_inner,
.sc_layouts_row_type_narrow .search_wrap .search_submit_inner,
.scheme_self.sc_layouts_row_type_compact .search_form_wrap_inner .search_submit_inner,
.scheme_self.sc_layouts_row_type_normal .search_wrap .search_submit_inner,
.scheme_self.sc_layouts_row_type_narrow .search_wrap .search_submit_inner {
	color: {$colors['inverse_text']};
	background-color: {$colors['text_link2']};
}
.sc_layouts_row_type_compact .search_form_wrap_inner .search_submit_inner:hover,
.sc_layouts_row_type_normal .search_wrap .search_submit_inner:hover,
.sc_layouts_row_type_narrow .search_wrap .search_submit_inner:hover,
.scheme_self.sc_layouts_row_type_compact .search_form_wrap_inner .search_submit_inner:hover,
.scheme_self.sc_layouts_row_type_normal .search_wrap .search_submit_inner:hover,
.scheme_self.sc_layouts_row_type_narrow .search_wrap .search_submit_inner:hover {
	color: {$colors['text_link2']};
	background-color: {$colors['inverse_text']};
}
...
.top_panel_default .sc_layouts_title .sc_layouts_title_breadcrumbs,
.top_panel_default .sc_layouts_title .sc_layouts_title_breadcrumbs a {
	color: {$colors['inverse_text']};
}
.top_panel_default .sc_layouts_title .sc_layouts_title_breadcrumbs a:hover {
	color: {$colors['text_hover2']};
}
.top_panel_default .sc_layouts_title .sc_layouts_title_caption {
	color: {$colors['inverse_text']};
}
...
.sc_layouts_language_menu.sc_layouts_dropdown li.menu-item.menu-item-has-children > a:before,
.sc_layouts_language_menu.sc_layouts_dropdown li.menu-item.menu-item-has-children > a:after {
	color: {$colors['alter_light']};
}
.sc_layouts_language_menu.sc_layouts_dropdown li.sfHover > a,
.sc_layouts_language_menu.sc_layouts_dropdown li.menu-item > a:hover {
	color: {$colors['text_dark']}!important;
}
.sc_layouts_language_menu.sc_layouts_dropdown li li.menu-item > a:hover {
	color: {$colors['text_link2']}!important;
}
.scheme_dark .sc_layouts_language_menu.sc_layouts_dropdown li.menu-item > a:hover {
	color: {$colors['text_link2']}!important;
}
.sc_layouts_language_menu.sc_layouts_dropdown li.menu-item > a:hover:before,
.sc_layouts_language_menu.sc_layouts_dropdown li.menu-item > a:hover:after {
	color: {$colors['text_link2']};
}
...
.top_panel_default .sc_layouts_row_type_normal .sc_layouts_title_meta .post_meta,
.top_panel_default .sc_layouts_row_type_normal .sc_layouts_title_meta .post_meta_item,
.top_panel_default .sc_layouts_row_type_normal .sc_layouts_title_meta .post_meta_item.post_categories,
.top_panel_default .sc_layouts_row_type_normal .sc_layouts_title_meta a.post_meta_item,
.top_panel_default .sc_layouts_row_type_normal .sc_layouts_item a:not(.sc_button):not(.button) {
	color: {$colors['inverse_link']};
}
.top_panel_default .sc_layouts_row_type_normal .sc_layouts_title .post_meta_item:after {
	color: {$colors['inverse_link']};
}
.top_panel_default .sc_layouts_row_type_normal .sc_layouts_item a:not(.sc_button):not(.button):hover {
	color: {$colors['text_hover2']};
}
...
.kargo_tabs .kargo_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.kargo_tabs .kargo_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.sheme_self.sidebar .kargo_tabs .kargo_tabs_titles li.ui-state-active a {
...
.post_item_single .post_meta .post_meta_item.post_categories a:after {
	color: {$colors['text_light']};
}
.post_date a:hover,
...
.post_layout_excerpt.sticky .more-link.sc_button_hover_slide_left,
.post_layout_chess.sticky .more-link.sc_button_hover_slide_left {
	color: {$colors['inverse_text']};
}
...
.format-video .post_featured.with_thumb .post_video_hover:hover span {
	color: {$colors['text_link2']};
}
...
div.kargo_tabs .kargo_tabs_titles li.ui-tabs-active a:after {
...
.nav-links-single .nav-links a:hover:before {
	color: {$colors['inverse_text']};
	background-color: {$colors['text_link2']};
}
...
.scheme_self.author_info .author_title .fn {
...
.related_item_style_2 .more-link:hover {
	color: {$colors['text_link2']};
}
...
.related_wrap.services_page_related .sc_services_item_title a,
.sc_services_default .sc_services_item_title a {
	color: {$colors['text_link2']};
}
.related_wrap.services_page_related .sc_services_item_title a:hover,
...
.related_wrap.services_page_related .sc_button.sc_button_simple:hover:before,
.sc_services_default .sc_button.sc_button_simple:hover:before {
	color: {$colors['bg_color']}!important;
}
.related_wrap.services_page_related .slider_outer_controls_top .slider_controls_wrap>a {
	background-color: {$colors['alter_bg_hover']};
}
.related_wrap.services_page_related .slider_outer_controls_top .slider_controls_wrap>a:hover {
	background-color: {$colors['text_link2']};
}
...
.comments_list_wrap .comment_posted .comment_counters a {
	color: {$colors['text_light']};
}
.comments_list_wrap .comment_posted .comment_counters a:hover {
	color: {$colors['text_dark']};
}
...
.sidebar .widget.widget_twitter .widget_title {
	color: {$colors['inverse_text']};
}
.sidebar .widget.widget_twitter a {
	color: {$colors['inverse_text']};
}
.sidebar .widget.widget_twitter a:hover {
	color: {$colors['text_hover2']};
}
.sidebar  .widget_twitter .widget_content .sc_twitter_list li {
	color: {$colors['inverse_text']};
}
...
.widget_recent_posts .post_item .post_content .post_categories a {
	color: {$colors['text_link2']};
}
.widget_recent_posts .post_item .post_content .post_categories a:hover {
	color: {$colors['text_dark']};
}
.widget_recent_posts .post_item .post_content .post_title a {
	color: {$colors['text_dark']};
}
.widget_recent_posts .post_item .post_content .post_title a:hover {
	color: {$colors['text_link2']};
}
...
.sidebar .wp-calendar-table td#next a:before {
	background-color: {$colors['alter_bg_color']};
}
.scheme_self.sidebar .widget_calendar td#prev a:before,
.scheme_self.sidebar .widget_calendar td#next a:before
.scheme_self.sidebar .wp-calendar-table td#prev a:before,
.scheme_self.sidebar .wp-calendar-table td#next a:before {
	background-color: {$colors['alter_bg_color']};
}

.content .widget_calendar td#prev a:before,
.content .widget_calendar td#next a:before,
.content .wp-calendar-table td#prev a:before,
.content .wp-calendar-table td#next a:before {
	background-color: {$colors['bg_color']};
}
.scheme_self.content .widget_calendar td#prev a:before,
.scheme_self.content .widget_calendar td#next a:before
.scheme_self.content .wp-calendar-table td#prev a:before,
.scheme_self.content .wp-calendar-table td#next a:before {
	background-color: {$colors['bg_color']};
}
...
.elementor-widget-video .elementor-custom-embed-play:hover .eicon-play {
	background-color: {$colors['text_link2']};
}
.elementor-widget-video .elementor-custom-embed-play:hover .eicon-play:before {
	color: {$colors['inverse_text']};
}
.elementor-widget-video .elementor-custom-embed-play:hover .elementor-screen-only {
	color: {$colors['text_link2']};
}
...
.scheme_self.sidebar .widget_block .wp-block-tag-cloud .tag-cloud-link {
	color: {$colors['alter_dark']};
...
.scheme_self.sidebar .widget_block .wp-block-tag-cloud .tag-cloud-link:hover {
	background-color: {$colors['alter_link']};
}
...
CSS;
					...
					$rez            = apply_filters(
						'kargo_filter_get_css', $rez, array(
							'colors' => $colors,
							'scheme' => $s,
						)
					);
		...
		return apply_filters( 'kargo_filter_prepare_css', $css_str, $remove_spaces );
	}
}
