...
$kargo_args = array_merge(
	...
	(array) get_query_var( 'kargo_search_args' )
);
?><div class="search_wrap search_style_<?php echo esc_attr( $kargo_args['style'] ) . ( ! empty( $kargo_args['class'] ) ? ' ' . esc_attr( $kargo_args['class'] ) : '' ); ?>">
